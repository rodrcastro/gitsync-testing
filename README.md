...
What if I try to reference the space variable now? <code class="expression">space.vars.SpaceVariable</code> - this is done via Git.
...
[^4]: this is a third footnote for testing purposes!
